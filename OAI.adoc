...
NOTE: Unfortunately, GitHub does not render the OpenAPI document to user-friendly format, you have to look at it on this external link:https://petstore.swagger.io/?url=https://raw.githubusercontent.com/pawissanutt/OaaS/main/doc/tm/openapi.json[link].
