...
* link:example/README.adoc[the example usage]
...
== Deploying the cluster in Kubernetes

Check on link:deploy/local-k8s/README.adoc[this guide] to install *Oparaca* on local Kubernetes (ex. kind, k3d, Docker Desktop, Rancher Desktop).
