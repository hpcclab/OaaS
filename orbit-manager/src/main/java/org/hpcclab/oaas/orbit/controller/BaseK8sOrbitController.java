...
public abstract class BaseK8sOrbitController implements OrbitController {
  private static final Logger logger = LoggerFactory.getLogger(BaseK8sOrbitController.class);
  long id;
  String prefix;
  String namespace;
  ...
  protected BaseK8sOrbitController(OrbitTemplate template,
  ...
  @Override
  public OrbitOperation createUpdateOperation(OrbitDeploymentPlan plan, DeploymentUnit unit) {
  ...
  @Override
  public OrbitOperation createDeployOperation(OrbitDeploymentPlan plan, DeploymentUnit unit)
  ...
  public List<? extends HasMetadata> deployShared(OrbitDeploymentPlan plan) throws OrbitDeployException {
    var labels = Map.of(
  ...
  public List<? extends HasMetadata> deployObjectModule(OrbitDeploymentPlan plan, DeploymentUnit unit) {
    var labels = Map.of(
      ORBIT_LABEL_KEY, String.valueOf(id),
  ...
  public List<HasMetadata> deployExecutionModule(OrbitDeploymentPlan plan) {
    // no needed
    return List.of();
  }

  public List<HasMetadata> deployDataModule(OrbitDeploymentPlan plan) throws OrbitDeployException {
    var labels = Map.of(
      ORBIT_LABEL_KEY, String.valueOf(id),
  ...
  public abstract List<HasMetadata> deployFunction(OrbitDeploymentPlan plan,
                                      ProtoOFunction function) throws OrbitDeployException;

  public abstract List<HasMetadata> removeFunction(String fnKey) throws OrbitUpdateException;

  @Override
  public OrbitOperation createDetachOperation(ProtoOClass cls) throws OrbitUpdateException {
    // TODO send signal
  ...
  @Override
  public OrbitOperation createDestroyOperation() throws OrbitUpdateException {
